...
`
	...
	GUI_HOME_REG_PATHRELATIVE_ALL       = 0                     // 预览页面相对目录替换索引 整个内容
	GUI_HOME_REG_PATHRELATIVE_PREFIX    = 1                     // 预览页面相对目录替换 前缀
	GUI_HOME_REG_PATHRELATIVE_BASE      = 2                     // 预览页面相对目录替换 文件名
	GUI_HOME_REG_PATHRELATIVE_NUM       = 3                     // 预览页面相对目录替换 合法匹配数量
	GUI_HOME_REG_PATHRELATIVE_EXCEPTION = "/"                   // 预览页面相对目录替换 不处理的内容
